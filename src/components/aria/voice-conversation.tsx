 ...
 * No manual send button. No persistent text input. Just talk.
 */
export function VoiceConversation({
  ...
  // Voice recorder — when transcription comes back, send directly to ARIA
  ...
  }, [exchanges, thinking, partialUserText]);
  ...
  return (
    <div className="flex flex-col h-full bg-[#1a1614]">
      ...
      <div className="px-4 py-3 border-b border-white/5 flex items-center justify-between">
        <div>
          ...
          <div className="text-[10px] text-[#8a7d72]">
            Push to talk · she hears, thinks, replies
          </div>
        </div>
        {speech.speaking && (
          <div
      ...
      >
        {exchanges.length === 0 && !partialUserText && !thinking && (
          <div className="h-full flex flex-col items-center justify-center text-center px-6">
            ...
            <p className="text-[11px] text-[#5a4a42] leading-relaxed max-w-xs">
              No send button. No typing. ARIA listens, thinks, and replies by
              voice. Your exchange shows up here as a transcript.
            </p>
          </div>
        )}
      ...
      <div className="border-t border-white/5 px-4 py-4">
        ...
        {recorder.recording && (
          <div className="mb-3 flex items-center gap-2 px-3 py-2 rounded-xl bg-[#3a2e28] border border-red-400/30">
            ...
            <span className="text-xs text-[#e8e2db]">listening…</span>
        ...
        {recorder.error && (
          <div className="mb-3 text-[11px] text-red-300 px-3 py-2 rounded-md bg-red-900/20">
            {recorder.error}
          </div>
        )}
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <button
            ...
            disabled={thinking || recorder.loading || speech.speaking}
            ...
            title={recorder.recording ? "Stop" : "Push to talk"}
